...
class SensorboxConnector:
    ...
    def connect(self):
        ...
        self.__call_method(f"write_prm 255")
...
#    with open("/home/smartpouch/purple_log.ljson", "a") as f:
...
#    elif event["type"] == "meas":
#        #print("alpha", event)
#        payload = f"schnieboard_meas,sensor=pouch01,type=meas x={event['High']['x']},y={event['High']['y']},z={event['High']['z']},xL={event['Low']['x']},yL={event['Low']['y']},zL={event['Low']['z']},magni={event['magni']},temp={event['temp']} {time_str}"
#        print(payload)
#    else:
#        print(event)
#    # try:
